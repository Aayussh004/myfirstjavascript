...
const myArr2 = new Array(1, 2, 3, 4)//aur ye ek dynamic array 
// console.log(myArr[1]);
...
const myn1 = myArr.slice(1, 3)//copied and sliced to new array1
...
const myn2 = myArr.splice(1, 3)//new array2 storing spliced array 
console.log("C(original array) => ", myArr);//original array
